...
namespace Courses_FrontEnd.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            if (!_roleManager.RoleExistsAsync(SD.Student_Role).GetAwaiter().GetResult()) {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
...

                {
                    ...
                    {
                        await _userManager.AddToRoleAsync(user, SD.Student_Role);
                    }
